...
import 'package:musicapp/utils/r&b_page_services.dart';

class RandBPage extends StatefulWidget {
  @override
  _RandBPageState createState() => _RandBPageState();
}

class _RandBPageState extends State<RandBPage> {
  //
    ...
    return MaterialApp(
      ...
      home: Scaffold(
        appBar: AppBar(
          ...
          title: Text(
            _loading ? 'loading...please wait' : 'R&B Music',
